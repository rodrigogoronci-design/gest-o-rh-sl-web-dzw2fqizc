...
//   $function$
//
// FUNCTION sync_transporte_to_ticket()
...
// Table: beneficios_transporte
//   on_transporte_changes_sync_ticket: CREATE TRIGGER on_transporte_changes_sync_ticket AFTER INSERT OR UPDATE OF ferias, atestados, faltas ON public.beneficios_transporte FOR EACH ROW EXECUTE FUNCTION sync_transporte_to_ticket()
