...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      atividades_comerciais_historico: {
        Row: {
          atividade_id: string
          created_at: string
          descricao: string
        ...
        Relationships: [
          {
            foreignKeyName: "atividades_comerciais_historico_atividade_id_fkey"
            columns: ["atividade_id"]
            isOneToOne: false
            referencedRelation: "atividades_comerciais"
            referencedColumns: ["id"]
          },
        ]
      }
...
// Table: atividades_comerciais_historico
//   id: uuid (not null, default: gen_random_uuid())
...
// Table: atividades_comerciais_historico
//   FOREIGN KEY atividades_comerciais_historico_atividade_id_fkey: FOREIGN KEY (atividade_id) REFERENCES atividades_comerciais(id) ON DELETE CASCADE
//   PRIMARY KEY atividades_comerciais_historico_pkey: PRIMARY KEY (id)
// Table: auditoria_acessos
...
//     WITH CHECK: true
// Table: atividades_comerciais_historico
//   Policy "historico_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "historico_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: true
//   Policy "historico_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "historico_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: auditoria_acessos
//   Policy "Allow all access to authenticated users" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
...
//     WITH CHECK: true
// Table: colaboradores
//   Policy "colaboradores_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (app_source = 'controle-de-beneficios'::text)
//   Policy "colaboradores_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: ((app_source = 'controle-de-beneficios'::text) AND ((user_id = auth.uid()) OR is_in_my_team(id)))
...
//     AND app_source = 'controle-de-beneficios'
//     LIMIT 1;
//   $function$
//   
